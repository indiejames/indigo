...
//
// A pattern error (a half-typed regex, which search-as-you-type produces
// constantly) comes back as an ordinary error value from a successful call, not
// as an RPC failure, so it cannot be mistaken for the connection being in
// trouble.

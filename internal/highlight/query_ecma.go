...
// ecmaHighlightQuery is ported verbatim from Helix's
// runtime/queries/ecma/highlights.scm — the shared base that TypeScript,
// TSX, and JavaScript's own queries all layer on top of via Helix's
// "; inherits: ecma" mechanism. See THIRD_PARTY_NOTICES.md for source

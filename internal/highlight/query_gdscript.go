...
// gdscriptHighlightQuery is ported from Helix's
// runtime/queries/gdscript/highlights.scm. See THIRD_PARTY_NOTICES.md for
// source commit and license (MPL-2.0).
//
// Changes from upstream: the "(underscore) @type.builtin" pattern (for the
// "_" wildcard token) was dropped — the vendored tree-sitter-gdscript
// grammar has no (underscore) node — otherwise verbatim.

...
// typescriptHighlightQuery and tsxHighlightQuery are ported from Helix's
// runtime/queries/{ecma,_typescript,_jsx}/highlights.scm, concatenated here
// because go-sitter-forest returns the raw upstream query text and this
// project's query engine doesn't resolve Helix's "; inherits:" directives.
...
var tsxHighlightQuery = typescriptHighlightQuery + `
; Punctuation
; -----------
